...
### Overview
This project addresses the limited linguistic support for Kapampangan in mainstream LLMs. By combining a fine-tuned Qwen-1.7B model with a Retrieval-Augmented Generation (RAG) pipeline, the system provides precise translations grounded in verified dictionary data.
...
* **scripts/**: 
    ...
    * **RAG-Finetuned.py**: The main interactive RAG loop.
